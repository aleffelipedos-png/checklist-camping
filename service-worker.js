const CACHE='meu-camping-v7522';
const CORE=['./','./index.html','./manifest.json','./camping-banner.jpg','./avatar-1.webp','./avatar-2.webp','./avatar-3.webp','./avatar-4.webp','./avatar-5.webp','./icon-192.png','./icon-512.png'];
